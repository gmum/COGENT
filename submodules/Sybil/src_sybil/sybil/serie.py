...
if __name__ == "__main__":
    ...
    root_dir = Path("/mnt/evafs/groups/mi2lab/data/ct_pretraining/abdominal_trauma/train_images/34522/64561")
    files = [root_dir / f"{i}.dcm" for i in range(1, 597)]
    serie = Serie(files, file_type="dicom")
    x = serie.get_volume()
    print(x.shape)
